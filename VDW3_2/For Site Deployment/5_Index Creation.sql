...
BEGIN
    ...
    END;
    ---CHORDS_DIAGNOSES_INDEX3
    IF EXISTS (SELECT *  FROM sys.indexes  WHERE name='CHORDS_DIAGNOSES_INDEX3' AND object_id = OBJECT_ID('DIAGNOSES'))
    BEGIN
	   PRINT 'CHORDS_DIAGNOSES_INDEX3 ALREADY EXISTS';
    END;
    ELSE
    BEGIN
	   PRINT 'CREATING CHORDS_DIAGNOSES_INDEX3';
	   CREATE NONCLUSTERED INDEX CHORDS_DIAGNOSES_INDEX3 ON [dbo].[DIAGNOSES]  ( [DX_CODETYPE] , [DX] ) INCLUDE ( [ADATE],[PERSON_ID] )
	   PRINT 'CHORDS_DIAGNOSES_INDEX3 - CREATED';
    END;
    ---CHORDS_DIAGNOSES_INDEX4
    IF EXISTS (SELECT *  FROM sys.indexes  WHERE name='CHORDS_DIAGNOSES_INDEX4' AND object_id = OBJECT_ID('DIAGNOSES'))
    BEGIN
	   PRINT 'CHORDS_DIAGNOSES_INDEX4 ALREADY EXISTS';
    END;
    ELSE
    BEGIN
	   PRINT 'CREATING CHORDS_DIAGNOSES_INDEX4';
	   CREATE NONCLUSTERED INDEX CHORDS_DIAGNOSES_INDEX4 ON [dbo].[DIAGNOSES]  ( [DX_CODETYPE] , [DX] ) INCLUDE ( [ENC_ID],[ADATE],[PERSON_ID] )
	   PRINT 'CHORDS_DIAGNOSES_INDEX4 - CREATED';
    END;
    ---CHORDS_DIAGNOSES_INDEX5
    IF EXISTS (SELECT *  FROM sys.indexes  WHERE name='CHORDS_DIAGNOSES_INDEX5' AND object_id = OBJECT_ID('DIAGNOSES'))
    BEGIN
	   PRINT 'CHORDS_DIAGNOSES_INDEX5 ALREADY EXISTS';
    END;
    ELSE
    BEGIN
	   PRINT 'CREATING CHORDS_DIAGNOSES_INDEX5';
    CREATE NONCLUSTERED INDEX CHORDS_DIAGNOSES_INDEX5 ON [dbo].[DIAGNOSES]  ( [DX_CODETYPE] ) INCLUDE ( [ENC_ID],[DX],[PERSON_ID] )
	   PRINT 'CHORDS_DIAGNOSES_INDEX5 - CREATED';
    END;
    ---CHORDS_DIAGNOSES_INDEX6
    IF EXISTS (SELECT *  FROM sys.indexes  WHERE name='CHORDS_DIAGNOSES_INDEX6' AND object_id = OBJECT_ID('DIAGNOSES'))
    BEGIN
	   PRINT 'CHORDS_DIAGNOSES_INDEX6 ALREADY EXISTS';
    END;
    ELSE
    BEGIN
	   PRINT 'CREATING CHORDS_DIAGNOSES_INDEX6';
    CREATE NONCLUSTERED INDEX CHORDS_DIAGNOSES_INDEX6 ON [dbo].[DIAGNOSES]  ( [DX],[DX_CODETYPE] ) INCLUDE ( [ENC_ID],[PERSON_ID] )
	   PRINT 'CHORDS_DIAGNOSES_INDEX6 - CREATED';
    END;
    ---CHORDS_DIAGNOSES_INDEX7
    IF EXISTS (SELECT *  FROM sys.indexes  WHERE name='CHORDS_DIAGNOSES_INDEX7' AND object_id = OBJECT_ID('DIAGNOSES'))
    BEGIN
	   PRINT 'CHORDS_DIAGNOSES_INDEX7 ALREADY EXISTS';
    END;
    ELSE
    BEGIN
	   PRINT 'CREATING CHORDS_DIAGNOSES_INDEX7';
	   CREATE NONCLUSTERED INDEX CHORDS_DIAGNOSES_INDEX7 ON [dbo].[DIAGNOSES]  ( [DX_CODETYPE] , [DX] ) INCLUDE ( [ENC_ID],[PERSON_ID] )
	   PRINT 'CHORDS_DIAGNOSES_INDEX7 - CREATED';
    END;
END;
...
BEGIN
    ...
    END;
    --CHORDS_PROCEDURES_INDEX3
    IF EXISTS (SELECT *  FROM sys.indexes  WHERE NAME = 'CHORDS_PROCEDURES_INDEX3' AND OBJECT_ID = OBJECT_ID('PROCEDURES'))
    BEGIN
	   PRINT 'CHORDS_PROCEDURES_INDEX3 ALREADY EXISTS';
    END;
    ELSE
    BEGIN
	   PRINT 'CREATING CHORDS_PROCEDURES_INDEX3';
	   CREATE NONCLUSTERED INDEX CHORDS_PROCEDURES_INDEX3 ON [dbo].[PROCEDURES]  ( [PX] ) INCLUDE ( [ENC_ID],[PERSON_ID],[ADATE] )
	   PRINT 'CHORDS_PROCEDURES_INDEX3 - CREATED';
    END;
END;
...
BEGIN
    ...
    END;
    --CHORDS_VITAL_SIGNS_INDEX3
    IF EXISTS (SELECT *  FROM sys.indexes  WHERE NAME = 'CHORDS_VITAL_SIGNS_INDEX3' AND OBJECT_ID = OBJECT_ID('VITAL_SIGNS'))
    BEGIN
	   PRINT 'CHORDS_VITAL_SIGNS_INDEX3 ALREADY EXISTS';
    END;
    ELSE
    BEGIN
	   PRINT 'CREATING CHORDS_VITAL_SIGNS_INDEX3';
	   CREATE NONCLUSTERED INDEX CHORDS_VITAL_SIGNS_INDEX3 ON [dbo].[VITAL_SIGNS]  ( [MEASURE_DATE],[WT] ) INCLUDE ( [PERSON_ID],[MEASURE_TIME],[HT] )
	   PRINT 'CHORDS_VITAL_SIGNS_INDEX3 - CREATED';
    END;
    --CHORDS_VITAL_SIGNS_INDEX4
    IF EXISTS (SELECT *  FROM sys.indexes  WHERE NAME = 'CHORDS_VITAL_SIGNS_INDEX4' AND OBJECT_ID = OBJECT_ID('VITAL_SIGNS'))
    BEGIN
	   PRINT 'CHORDS_VITAL_SIGNS_INDEX4 ALREADY EXISTS';
    END;
    ELSE
    BEGIN
	   PRINT 'CREATING CHORDS_VITAL_SIGNS_INDEX4';
	   CREATE NONCLUSTERED INDEX CHORDS_VITAL_SIGNS_INDEX4 ON [dbo].[VITAL_SIGNS]  ( [MEASURE_DATE],[WT] ) INCLUDE ( [PERSON_ID],[MEASURE_TIME] )
	   PRINT 'CHORDS_VITAL_SIGNS_INDEX4 - CREATED';
    END;
END;
...
BEGIN
    ...
    BEGIN
	   ...
	   CREATE CLUSTERED INDEX CHORDS_LINKAGE_INDEX ON LINKAGE (PERSON_ID);
...
BEGIN
    --BENEFIT_TUMOR_INDEX
    IF EXISTS (SELECT *  FROM sys.indexes  WHERE NAME = 'BENEFIT_TUMOR_INDEX' AND OBJECT_ID = OBJECT_ID('BENEFIT'))
	   BEGIN
    ...
    BEGIN
		...
		CREATE CLUSTERED INDEX CHORDS_BENEFIT_INDEX ON BENEFIT (PERSON_ID);
