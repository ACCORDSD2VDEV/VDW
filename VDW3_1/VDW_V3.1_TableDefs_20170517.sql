...
BEGIN
	 ...
	 (
					  ...
					  AHFS6      nvarchar(8),
					  AHFS7      nvarchar(8),
					  CONSTRAINT PK_EVERNDC PRIMARY KEY CLUSTERED(NDC, GENERIC)
	 );
...
BEGIN
	 ...
	 (
					  ...
					  [SOURCE]       nchar NOT NULL,
					  CONFIDENCE     nchar NOT NULL,
					  CONSTRAINT PK_CAUSE_OF_DEATH PRIMARY KEY CLUSTERED(PERSON_ID, COD)
	 );
...
BEGIN
	 ...
	 (
					  ...
					  PCC                    nvarchar(4),
					  PCP                    nvarchar(36),
					  CONSTRAINT PK_ENROLLMENT PRIMARY KEY CLUSTERED(PERSON_ID, ENR_START),
					  CONSTRAINT FK_ENROLLMENT_DEMOGRAPHICS FOREIGN KEY(PERSON_ID) REFERENCES DEMOGRAPHICS(PERSON_ID),
					  CONSTRAINT FK_ENROLLMENT_PROVIDER_SPECIALTY FOREIGN KEY(PCP) REFERENCES PROVIDER_SPECIALTY([PROVIDER])
	 );
...
BEGIN
	 ...
	 (
					  ...
					  CONSTRAINT FK_LANGUAGES_LANGUAGES_ISO_LU FOREIGN KEY(LANG_ISO) REFERENCES LANGUAGES_ISO_LU([ISO_639-2_CODE])
	 );
...
BEGIN
	 ...
	 (
					  ...
					  CONSTRAINT PK_CENSUS_LOCATION PRIMARY KEY CLUSTERED(PERSON_ID, LOC_START),
					  CONSTRAINT FK_CENSUS_LOCATION_DEMOGRAPHICS FOREIGN KEY(PERSON_ID) REFERENCES DEMOGRAPHICS(PERSON_ID)
	 );
