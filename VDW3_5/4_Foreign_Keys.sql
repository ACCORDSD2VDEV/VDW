...
ELSE
BEGIN
    PRINT 'SESSION - Creating Foreign Keys';

    ---Foreign Keys to required/priority tables
    ALTER TABLE [SESSION]
	   ADD CONSTRAINT FK_CHORDS_SESSION_DEMOGRAPHICS FOREIGN KEY(PERSON_ID) REFERENCES DEMOGRAPHICS(PERSON_ID),
	       CONSTRAINT FK_CHORDS_SESSION_ENCOUNTERS FOREIGN KEY(ENC_ID) REFERENCES ENCOUNTERS(ENC_ID);

    PRINT 'SESSION - Foreign Keys Added';
END;
