...
BEGIN
	 ...
	 (
					  ...
					  CONSTRAINT PK_CHORDS_LINKAGE PRIMARY KEY CLUSTERED(CID, LINE)
	 );
...
ELSE
BEGIN
	 PRINT 'PROGRAM - Creating';
	 CREATE TABLE PROGRAM
	 (
					  PROGRAMID                     int IDENTITY(1,1) PRIMARY KEY NONCLUSTERED,
					  PROGRAM_NAME                  nchar(50) NOT NULL,
					  PROGRAM_DESCRIPTION           nchar(250) NOT NULL,
					  PROGRAM_SETTING               nchar(15) NOT NULL,
					  AFFILIATED_PROGRAMID          int NULL,
					  AIM_NUTRITION                 numeric(1) NOT NULL,
					  AIM_ACTIVITY                  numeric(1) NOT NULL,
					  AIM_WEIGHT                    numeric(1) NOT NULL,
					  PRESCRIBED_TOTAL_DOSE         numeric(4) NOT NULL,
					  PRESCRIBED_PROGRAM_DURATION   numeric(3) NOT NULL,
					  PRESCRIBED_SESSION_FREQUENCY  numeric(1) NOT NULL,
					  PRESCRIBED_SESSION_LENGTH		numeric(2) NOT NULL,
					  LOCATION_ADDRESS		        nchar(50) NULL,
					  LOCATION_LATITUDE             numeric(8) NULL,
					  LOCATION_LONGITUDE            numeric(8) NULL,
					  LOCATION_GEOCODE              nvarchar(15) NULL,
					  LOCATION_BOUNDARY_YEAR        numeric(8) NULL,
					  LOCATION_GEOLEVEL             nvarchar(15) NULL,
					  SESSION_OMISSION_PERCENT      numeric(3) NULL,
					  SESSION_OMISSION_DESCRIPTION  nvarchar(200) NULL,
					  SESSION_OMISSION_SYSTEMATIC   numeric(1) NULL
	 );
...
BEGIN
	 ...
	 (
					  ...
					  SESSION_MODE                  nvarchar(15) NULL,
					  SCREENING                     numeric(1) NULL,
					  COUNSELING                    numeric(1) NULL,
					  INTERVENTION_ACTIVITY         numeric(1) NULL,
					  INTERVENTION_NUTRITION        numeric(1) NULL,
					  INTERVENTION_NAVIGATION		numeric(1) NULL,
					  DOSE           		        numeric(3) NULL
	 );
	 PRINT 'PROGRAM - Complete';
END;
